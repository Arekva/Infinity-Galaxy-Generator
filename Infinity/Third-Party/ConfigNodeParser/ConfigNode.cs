...
namespace ConfigNodeParser
{
    public class ConfigNode
    {
        ...
        {
            return ConfigNodeWriter.FileToConfigNode(this, fileFullName, header);
        }
        ...
        {
            //Yuck
            string configNodeString = ConfigNodeWriter.ConfigNodeToString(this);
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            sb.AppendLine("{");
            using (System.IO.StringReader sr = new System.IO.StringReader(configNodeString))
            {
                string currentLine;
